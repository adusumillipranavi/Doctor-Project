<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Doctor_Update.aspx.cs" Inherits="Admin_Doctor_Registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../Codescripts/Admin_Doctor_Update.js"></script>
</asp:Content>
    ...
    <div class="row">
        ...
        <table style="width: 100%;" cellspacing="10">
            <tr>
                ...
                <td colspan="2">
                    <input class="form-control" id="txtname" maxlength="80" runat="server" placeholder="Enter Doctor Name" />
                </td>
            ...
            <form id="form1" runat="server">
                <tr>
                    ...
                    <td colspan="2">
                        <input class="form-control" id="Text3" runat="server" placeholder="Enter Education (Shortcuts) (Ex: Bsc.Com)" />
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div id="Educationdiv" runat="server">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:HiddenField ID="studiedin" runat="server" />
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:HiddenField ID="workedin" runat="server" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:HiddenField ID="specialist" runat="server" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:HiddenField ID="expertise" runat="server" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top" colspan="2">
                        <div id="ExperienceTextboxesdiv" runat="server">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top" colspan="2">
                        <div id="MemberTextboxdiv" runat="server">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top" colspan="2">
                        <div id="AwardsTextboxdiv" runat="server">
            ...
            <tr>
                ...
                <td>
                    <textarea id="TextArea1" runat="server" class="form-control" cols="20" maxlength="500" rows="2" placeholder="Say Some thing about About Doctor" style="resize: none;"></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <a style="float: right" class="btn btn-primary" href="javascript:" onclick="updatedoctor()">Submit</a>
                </td>
            </tr>
        </table>
    </div>
